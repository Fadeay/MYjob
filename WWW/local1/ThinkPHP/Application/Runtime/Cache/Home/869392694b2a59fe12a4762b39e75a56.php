...
<nav class="navbar navbar-inverse" role="navigation">
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav">
      <li class="active"><a href="/ThinkPHP/Home/Code/url"><?php echo ($webtitle); ?></a></li>
      <li class="dropdown">
...
<div class="container-fluid">
    <div style="margin-top: 10%" class="row">
        <div class="col-md-5 col-md-offset-1">
            <form class="" action="/ThinkPHP/Home/Code/url" method="post">
                ...
                <div class="form-group">
                    <button name="way" type="submit" class="btn btn-primary" value="encode">加密</button>
                    <button name="way" type="submit" class="btn btn-primary" value="decode">解密</button>
                </div>
                <div class="form-group">
                    <div class="input-group">
